...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()."index.php/chart"; ?>">Temperature & Humidity</a></li>
            <li><a href="<?php echo base_url()."index.php/stream"; ?>">Live Streaming</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
 ...
 <!-- Content Wrapper. Contains page content -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="">UniKL MFI</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
